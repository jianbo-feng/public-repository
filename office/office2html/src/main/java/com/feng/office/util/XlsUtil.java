...
public class XlsUtil {
    ...
    private File path = new File("/Users/baby/work/test/test-xls.xls");
    ...
    public static void main(String[] args) throws Exception {
        ...
        // xls.transform();
        InputStream isXlsx = new FileInputStream("/Users/baby/work/test/test-xls2.xlsx");
        XSSFWorkbook workbookOld = new XSSFWorkbook(isXlsx);

        String dest = "/Users/baby/work/test/test-xls2.xls";
