...
<head>
    ...
    <!--<link href="http://cron.qqe2.com/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="http://cron.qqe2.com/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="http://cron.qqe2.com/Cron/icon.css" rel="stylesheet" type="text/css" />-->
    <link href="/css/cron/themes/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="/css/cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .line
        {
            height: 25px;
