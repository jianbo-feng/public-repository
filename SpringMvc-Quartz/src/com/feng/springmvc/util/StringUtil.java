package com.feng.springmvc.util;
...
import com.feng.springmvc.common.Constants;
...
public class StringUtil {
    ...
    public static String trim(String src, String def) {
        ...
        return ("null".equals(src.toLowerCase()) || "".equals(src)) ? def : src;
    }
    ...
    public static int getLength(String value,String format) {
		...
		value = trim(value);
        if(!"".equals(value)) {
            format = trim(format,"UTF-8").toUpperCase();
            ...
            switch(format) {
                ...
                case "UTF-16LE" :
                    byteLen = 2; break;
                case "ISO-8859-1" : byteLen = 1; break;
                case "UTF-8" : byteLen = 3; break;
                case "UTF-16" : byteLen = 4; break;
            }
