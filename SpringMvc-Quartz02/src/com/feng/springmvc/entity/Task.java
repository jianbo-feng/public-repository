...
public class Task implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2795190477983704629L;
    ...
    public Task(String taskId, String taskName, String taskDesc, String taskCronExpression, String beanClass,
                String taskStatus, String taskGroup, String businessKey, String recordTime, Integer recordFlag,
                String creatorId, String updatorId, String updateTime,
                String creatorName, String updatorName, Integer repeatCount, Date startAt) {
        this.taskId = taskId;
        this.taskName = taskName;
        this.taskDesc = taskDesc;
        this.taskCronExpression = taskCronExpression;
