...
public class MD5 {
    ...
    public static void main(String... strs) throws Exception {
    	String str = "root";
    	System.err.println(DigestUtils.md5Hex("12345"));
    	System.err.println(Base64.encodeBase64String("root".getBytes("utf-8")));	// cm9vdA==
    	System.err.println(new String(Base64.decodeBase64("cm9vdA==".getBytes("utf-8"))));
    	System.err.println(getMD5Str(str));	// 63A9F0EA7BB98050796B649E85481845
    }
}
