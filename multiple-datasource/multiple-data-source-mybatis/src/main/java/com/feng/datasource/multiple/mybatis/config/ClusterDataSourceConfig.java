package com.feng.datasource.multiple.mybatis.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.feng.datasource.multiple.mybatis.repository.cluster", sqlSessionTemplateRef = "clusterSqlSessionTemplate")
public class ClusterDataSourceConfig {
	...
	public SqlSessionFactory productSqlSessionFactory(@Qualifier("clusterDataSource") DataSource dataSource) throws Exception {
		...
		bean.setTypeAliasesPackage("com.feng.datasource.multiple.mybatis.entity");
